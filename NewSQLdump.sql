...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COLLATE=utf8_danish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (6,'Henrik','Thorn','900150983cd24fb0d6963f7d28e17f72','henrik@abc.dk',1539260683),(7,'Henrik','Thorn','ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad','henrik@abc.dk',1539260935),(8,'Henrik','Thorn','ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad','henrik@abc.dk',1539277503),(9,'Henrik','Thorn','ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad','henrik@abc.dk',1539277743),(19,'null','null','5ae4cfc6e1e6d45589f52ac911ec312a023cdcc8e03ea053be0e657d25aeb6ea','henrik@abc.dk',1541518310),(22,'Mette flette','Borch','5ae4cfc6e1e6d45589f52ac911ec312a023cdcc8e03ea053be0e657d25aeb6ea','mette@borch.nu',1542718450);
...
-- Dump completed on 2018-11-26 16:59:56
